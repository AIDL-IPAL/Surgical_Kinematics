...
class DepthEstimator:
    ...
    def preprocess_image(self, 
        ...
        cropped_frame, intrinsic_cropped, crop_info = self.crop_with_intrinsics(image, intrinsics)
        h, w = cropped_frame.shape[:2]
        image = cropped_frame
        intrinsics = intrinsic_cropped
    ...
    def postprocess_depth(self,
                         ...
                         scaled_intrinsics: List[float]) -> np.ndarray:
        """
